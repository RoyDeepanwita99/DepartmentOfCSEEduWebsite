...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo">Database Management Systems Lab</span>
            </div>
...
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
    ...
    <div class="bg">
        ...
        <div class="jumbotron text-center">
            <h1 class="display-4">Database Management Systems Lab[CSE-2102]</h1>
            <p class="lead">This lab covers various topics includingincluding SQL Tutorial, entity relationship model,
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">SQL Tutorial</h2>
                            <p class="card-text" align="justify">  SQL is a standard database language used to access and manipulate data in databases.
							SQL stands for Structured Query Language. SQL was developed by IBM Computer Scientists in the 1970s. By executing queries SQL
							can create, update, delete, and retrieve data in databases like MySQL, Oracle, PostgreSQL, etc. Overall SQL is a query language 
							that communicates with databases.<br>
							
               It is a database computer language designed for the retrieval and management of data in a relational databases like MySQL, MS Access,
			   SQL Server, Oracle, Sybase, Informix, Postgres etc. SQL stands for Structured Query Language. SQL was developed in the 1970s by IBM 
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">   Normalization is the process of minimizing redundancy from a relation or set of relations. Redundancy 
							...
							guidelines, known as normal forms.</p>
                            <a href="#" class="btn btn-primary read-more">Read More...</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">   A Transaction is a logical unit of work.It is the set of operations( basically read and 
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php
$tag = "CSE2102"; // Set the desired tag value ---> course
