            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="index.php?q=1"><span
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!--home start-->
                    <?php if(@$_GET['q']==1) {
   $r1 = mysqli_query($con, "SELECT tag FROM quiz WHERE eid IN (SELECT eid FROM history WHERE email = '{$_SESSION['email']}')") or die('Error');

   while ($row = mysqli_fetch_array($r1)) {
       $tag = $row['tag'];
       if ($tag == "CSE1101") {
           header("location:CSE1101.php?q=1");
       } elseif ($tag == "CSE1102") {
           header("location:CSE1102.php?q=1");
       } elseif ($tag == "CSE3101") {
        header("location:CSE3101.php?q=1");
      } elseif ($tag == "CSE3102") {
          header("location:CSE3102.php?q=1");
        } else {
