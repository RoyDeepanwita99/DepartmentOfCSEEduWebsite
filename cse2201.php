...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo">Design and Analysis of Algorithms</span>
            </div>
...
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
    ...
    <div class="bg">
        ...
        <div class="jumbotron text-center">
            <h1 class="display-4">Design and Analysis of Algorithms[CSE-2201]</h1>
            <p class="lead">This course covers various topics including Minimum Spanning Trees,
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
							...
							the correct substring of string T [1……n] is T [1……j]. That is, either i>0 or j m-1 must exist.<br>
                </p>
                            <a href="#" class="btn btn-primary read-more">Read More...</a>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php
$tag = "CSE2201"; // Set the desired tag value ---> course
