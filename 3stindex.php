...
<div class="row">
<div class="col-lg-6">
<span class="logo">3rd Semester</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li><a href="cse2101.php?q=1">CSE-2101</a></li>
                <li><a href="cse2102.php?q=1">CSE-2102</a></li>
                <li><a href="#">CSE-2103</a></li>
                <li><a href="#">CSE-2104</a></li>
                <li><a href="#">EEE-2105</a></li>
                <li><a href="#">EEE-2106</a></li>
                <li><a href="#">CSE-2107</a></li>
                <li><a href="#">CSE-2108</a></li>
                <li><a href="#">MATH-2109</a></li>
...
<h1>University of Barishal - Department of Computer Science & Engineering</h1>
    ...
    <table>
        ...
        <tr>
            <td>Dtabase Management Systems Lab</td>
            <td>CSE-2102</td>
            <td>1.5</td>
            <td>45</td>
        </tr>
        ...
        <tr>
            <td>Complex Variable and Matrices</td>
            <td>MATH-2109</td>
            <td>1</td>
            <td>30</td>
        </tr>
    ...
    <div class="description">
        <h2>Description:</h2>
        <p>The 3rd semester curriculum at the Department of Computer Science & Engineering at the University of Barishal offers a comprehensive set of courses designed to provide students with in-depth knowledge and practical skills.</p>

        <p><strong>Dtabase Management Systems(CSE-2101):</strong> This course dives into the intricacies of microprocessors and microcontrollers, exploring their architectures and applications. With 45 hours of study, students gain a deep understanding of these fundamental components of modern computing systems.</p>

        <p><strong>Dtabase Management Systems Lab (CSE-2102):</strong> In this lab-based course, students apply their theoretical knowledge, working hands-on with assembly language, microprocessors, and microcontrollers. Through 45 hours of practical sessions, students enhance their programming and problem-solving skills.</p>
