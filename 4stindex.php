...
<div class="row">
<div class="col-lg-6">
<span class="logo">4th Semester</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li><a href="cse2201.php?q=1">CSE-2201</a></li>
                <li><a href="cse2202.php?q=1">CSE-2202</a></li>
                <li><a href="#">CSE-2203</a></li>
                <li><a href="#">CSE-2204</a></li>
                <li><a href="#">CSE-2205</a></li>
                <li><a href="#">EEE-2206</a></li>
                <li><a href="#">EEE-2207</a></li>
                <li><a href="#">ME-2208</a></li>
                <li><a href="#">ME-2209</a></li>
    </ul>
</li>
...
<h1>University of Barishal - Department of Computer Science & Engineering</h1>
    ...
    <table>
        ...
        <tr>
            <td>Vectors,Fourier Analysis,and Laplace Transforms</td>
            <td>MATH-2211</td>
            <td>3</td>
            <td>45</td>
        </tr>
    ...
    <div class="description">
        <h2>Description:</h2>
        <p>The 4th semester curriculum at the Department of Computer Science & Engineering at the University of Barishal offers a comprehensive set of courses designed to provide students with in-depth knowledge and practical skills.</p>

        <p><strong>Design and Analysis of Algorithms(CSE-2201):</strong> This course dives into the intricacies of microprocessors and microcontrollers, exploring their architectures and applications. With 45 hours of study, students gain a deep understanding of these fundamental components of modern computing systems.</p>

        <p><strong>Design and Analysis of Algorithms Lab (CSE-2202):</strong> In this lab-based course, students apply their theoretical knowledge, working hands-on with assembly language, microprocessors, and microcontrollers. Through 45 hours of practical sessions, students enhance their programming and problem-solving skills.</p>
        <p><strong>Computer Architecture and Organization (CSE-2203):</strong>Focusing on software engineering principles, this course equips students with methodologies for systematic software development and information system design. The 45-hour curriculum emphasizes both theory and practical applications.</p>
        <p><strong> Computer Architecture and Organization Lab (CSE-2204): </strong>In the lab sessions, students engage in real-world software engineering projects, honing their teamwork and project management abilities. Through 45 hours of guided practical work, students learn to develop robust software systems. </p>
