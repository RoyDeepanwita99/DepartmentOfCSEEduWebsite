...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo">Microprocessors and Microcontrollers Lab</span>
            </div>
...
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
    ...
    <div class="bg">
        ...
        <div class="jumbotron text-center">
            <h1 class="display-4">Assembly Language, Microprocessors, And Microcontrollers Lab [CSE-3102]</h1>
            <p class="lead">This lab covers various topics including microprocessor architectures, addressing modes,
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Integrating microprocessor with interfacing chips</h2>
                            <p class="card-text">This topic discusses the integration of microprocessors with This topic
                                explores different microprocessor architectures such as 8-bit, 16-bit, and 32-bit. It
                                covers addressing modes, instruction sets, interrupts, multitasking, and virtual memory.
                                Read more...This topic explores different microprocessor architectures such as 8-bit,
                                16-bit, and 32-bit. It covers addressing modes, instruction sets, interrupts,
                                multitasking, and virtual memory. Read more...This topic explores different
                                microprocessor architectures such as 8-bit, 16-bit, and 32-bit. It covers addressing
                                modes, instruction sets, interrupts, multitasking, and virtual memory. Read more...This
                                ...
                                memory. Read more...This topic explores different microprocessor architectures such as
                                8-bit, 16-bit, and 32-bit. It covers addressing modes, instruction sets, interrupts,
                                multitasking, and virtual memory. Read morevarious interfacing chips. It includes
                                methods to enable communication and control between microprocessors and external
                                devices. Read more...</p>
                            <a href="#" class="btn btn-primary read-more">Read More...</a>
                        </div>
                    </div>
...
//
//
$tag = "CSE3102"; // Set the desired tag value ---> semester
...
<div class="modal fade" id="rank">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                //ranking start
                $tag = 'CSE3102'; // Set the tag you want to filter
