...
<div class="row">
<div class="col-lg-6">
<span class="logo">Frist Semester</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <ul class="dropdown-menu">
                                <li><a href="cse1101.php?q=1">CSE-1101</a></li>
                                <li><a href="cse1102.php?q=1">CSE-1102</a></li>
                                <li><a href="#">CSE-1103</a></li>
                                <li><a href="#">CSE-1104</a></li>
                                <li><a href="#">PHY-1105</a></li>
                                <li><a href="#">PHY-1106</a></li>
                                <li><a href="#">CHEM-1107</a></li>
                                <li><a href="#">CHEM-1108</a></li>
                                <li><a href="#">MATH-1109</a></li>
                                <li><a href="#">ENG-1110</a></li>
                            </ul>
</li>
...
<h1>University of Barishal - Department of Computer Science & Engineering</h1>
    ...
    <table>
        ...
        <tr>
            <td>Introduction to Computer System Lab</td>
            <td>CSE-1102</td>
            <td>0.75</td>
            <td>30</td>
        </tr>
        ...
        <tr>
            <td>Differential Calculus and Co-ordinaate Geometry</td>
            <td>MATH-1109</td>
            <td>3</td>
            <td>45</td>
        </tr>
        <tr>
            <td>English Communication Skills Lab</td>
            <td>ENG-1110</td>
            <td>1.5</td>
            <td>45</td>
        </tr>
    ...
    <div class="description">
        <h2>Description:</h2>
        <p>The 1st semester curriculum at the Department of Computer Science & Engineering at the University of Barishal offers a comprehensive set of courses designed to provide students with in-depth knowledge and practical skills.</p>

        <p><strong>Introduction to Computer System (CSE-1101):</strong> This course dives into the intricacies of microprocessors and microcontrollers, exploring their architectures and applications. With 45 hours of study, students gain a deep understanding of these fundamental components of modern computing systems.</p>

        <p><strong>Introduction to Computer System Lab (CSE-1102):</strong> In this lab-based course, students apply their theoretical knowledge, working hands-on with assembly language, microprocessors, and microcontrollers. Through 45 hours of practical sessions, students enhance their programming and problem-solving skills.</p>
        <p><strong>Programming Fundamentals(CSE-1103):</strong>Focusing on software engineering principles, this course equips students with methodologies for systematic software development and information system design. The 45-hour curriculum emphasizes both theory and practical applications.</p>
        <p><strong> Programming Fundamentals Lab (CSE-1104): </strong>In the lab sessions, students engage in real-world software engineering projects, honing their teamwork and project management abilities. Through 45 hours of guided practical work, students learn to develop robust software systems. </p>
        <p><strong> Physics (PHY-1105): </strong>This course explores the architecture, protocols, and technologies that underpin modern computer networks. Through 45 hours of study, students delve into topics such as network design, implementation, and security, preparing them for the complexities of networking in the digital age.</p>
        <p><strong>  Physics Lab (PHY-1106):</strong> Through hands-on exercises and simulations, students in this lab course gain practical experience in configuring and troubleshooting computer networks. The 45-hour lab sessions enhance their skills in network administration and troubleshooting.</p>
