...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Semester</b></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Semester</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="tag" name="tag" placeholder="Enter course code.(Ex- CSE1101)" class="form-control input-md" type="text">
