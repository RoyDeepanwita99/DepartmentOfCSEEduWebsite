...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo">Data Structure Lab</span>
            </div>
...
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php?q=1" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
    ...
    <div class="bg">
        ...
        <div class="jumbotron text-center">
            <h1 class="display-4">Data Structures Lab [CSE-1202]</h1>
            <p class="lead">This lab covers various topics including sorting algorithms, dynamic programming,
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text" align="justify">   Dynamic Programming is a technique in computer programming that helps to efficiently solve a class of problems that have 
							overlapping subproblems and optimal substructure property.<br>
...
work of recomputing the answer every time it solves each subsubproblem.</p>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
							...
							the moment. It doesn't worry whether the current best result will bring the overall optimal result.<br>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">  Hash table is one of the most important data structures that uses a special function known as a hash function that maps a given value
				 with a key to access the elements faster.<br>
				 
               A Hash table is a data structure that stores some information, and the information has basically two main components, i.e., key 
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text"> Sorting techniques in data structures is a process of rearranging data elements in an array or list in order to make it easier 
				...
				searching the entire list would take too long if you have an unsorted list of 10 items.<br>
				
                However, searching for an item would be 
				...
				determine which one should come first in a sequence.</p>
                            <a href="#" class="btn btn-primary read-more">Read More...</a>
                        </div>
                    </div>
                </div>
...
$tag = "CSE1202"; // Set the desired tag value ---> course
